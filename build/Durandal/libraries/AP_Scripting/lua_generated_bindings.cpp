...
static int AP_Frsky_SPort_prep_number(lua_State *L) {
    ...
    if (ud == nullptr) {
        return luaL_argerror(L, 1, "frsky_sport not supported on this firmware");
    }
...
static int AP_MotorsMatrix_add_motor_raw(lua_State *L) {
    ...
    if (ud == nullptr) {
        return luaL_argerror(L, 1, "MotorsMatrix not supported on this firmware");
    }
...
static int QuadPlane_in_vtol_mode(lua_State *L) {
    ...
    if (ud == nullptr) {
        return luaL_argerror(L, 1, "quadplane not supported on this firmware");
    }
...
static int ScriptingLED_get_rgb(lua_State *L) {
    ...
    if (ud == nullptr) {
        return luaL_argerror(L, 1, "LED not supported on this firmware");
    }
