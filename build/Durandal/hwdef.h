...
#define HAL_WITH_SPI_EXTERNAL1M0 1
#define HAL_WITH_SPI_EXTERNAL1M1 1
#define HAL_WITH_SPI_EXTERNAL1M2 1
#define HAL_WITH_SPI_EXTERNAL1M3 1
#define HAL_WITH_SPI_EXTERNAL2M0 1
#define HAL_WITH_SPI_EXTERNAL2M1 1
#define HAL_WITH_SPI_EXTERNAL2M2 1
#define HAL_WITH_SPI_EXTERNAL2M3 1
#define HAL_WITH_SPI_EXTERNAL3M0 1
#define HAL_WITH_SPI_EXTERNAL3M1 1
#define HAL_WITH_SPI_EXTERNAL3M2 1
#define HAL_WITH_SPI_EXTERNAL3M3 1
#define HAL_WITH_SPI_EXTERNAL4M0 1
#define HAL_WITH_SPI_EXTERNAL4M1 1
#define HAL_WITH_SPI_EXTERNAL4M2 1
#define HAL_WITH_SPI_EXTERNAL4M3 1
#define HAL_WITH_SPI_EXTERNAL5M0 1
#define HAL_WITH_SPI_EXTERNAL5M1 1
#define HAL_WITH_SPI_EXTERNAL5M2 1
#define HAL_WITH_SPI_EXTERNAL5M3 1
...
{  77, true,  0, PAL_LINE(GPIOE,  5U)}, /* PE5 TIM15_CH1 TIM15 AF4 */ \
...
#define HAL_GPIO_PIN_TSENSE_CS            PAL_LINE(GPIOH,5U)
...
#define HAL_INS_PROBE2  ADD_BACKEND(AP_InertialSensor_BMI088::probe(*this,hal.spi->get_device("bmi055_a"),hal.spi->get_device("bmi055_g"),ROTATION_ROLL_180_YAW_90))
...
#define STM32_I2C_I2C1_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 1) // shared I2C1_TX,I2C3_RX
...
#define STM32_I2C_I2C2_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 4) // shared SPI2_TX,I2C2_TX,USART3_TX
#define STM32_I2C_I2C2_TX_DMA_CHAN     STM32_DMAMUX1_I2C2_TX
#define STM32_I2C_I2C3_RX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 1) // shared I2C1_TX,I2C3_RX
#define STM32_I2C_I2C3_RX_DMA_CHAN     STM32_DMAMUX1_I2C3_RX
#define STM32_I2C_I2C3_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 6) // shared SPI4_RX,I2C3_TX
#define STM32_I2C_I2C3_TX_DMA_CHAN     STM32_DMAMUX1_I2C3_TX
#define STM32_I2C_I2C4_RX_BDMA_STREAM  STM32_DMA_STREAM_ID(1, 0)
#define STM32_I2C_I2C4_RX_BDMA_CHAN    STM32_DMAMUX2_I2C4_RX
#define STM32_I2C_I2C4_TX_BDMA_STREAM  STM32_DMA_STREAM_ID(1, 4)
...
#define STM32_SPI_SPI2_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 4) // shared SPI2_TX,I2C2_TX,USART3_TX
#define STM32_SPI_SPI2_TX_DMA_CHAN     STM32_DMAMUX1_SPI2_TX
#define STM32_SPI_SPI4_RX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 6) // shared SPI4_RX,I2C3_TX
#define STM32_SPI_SPI4_RX_DMA_CHAN     STM32_DMAMUX1_SPI4_RX
#define STM32_SPI_SPI4_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 3) // shared SPI4_TX,USART2_TX
#define STM32_SPI_SPI4_TX_DMA_CHAN     STM32_DMAMUX1_SPI4_TX
#define STM32_SPI_SPI5_RX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 5) // shared SPI5_RX,USART6_TX
#define STM32_SPI_SPI5_RX_DMA_CHAN     STM32_DMAMUX1_SPI5_RX
#define STM32_SPI_SPI5_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 2)
#define STM32_SPI_SPI5_TX_DMA_CHAN     STM32_DMAMUX1_SPI5_TX
#define STM32_SPI_SPI6_RX_BDMA_STREAM  STM32_DMA_STREAM_ID(1, 6)
#define STM32_SPI_SPI6_RX_BDMA_CHAN    STM32_DMAMUX2_SPI6_RX
#define STM32_SPI_SPI6_TX_BDMA_STREAM  STM32_DMA_STREAM_ID(1, 2)
...
#define STM32_UART_UART8_RX_DMA_STREAM STM32_DMA_STREAM_ID(1, 0)
#define STM32_UART_UART8_RX_DMA_CHAN   STM32_DMAMUX1_UART8_RX
#define STM32_UART_UART8_TX_DMA_STREAM STM32_DMA_STREAM_ID(1, 1)
...
#define STM32_UART_USART2_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 3) // shared SPI4_TX,USART2_TX
...
#define STM32_UART_USART3_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 4) // shared SPI2_TX,I2C2_TX,USART3_TX
#define STM32_UART_USART3_TX_DMA_CHAN  STM32_DMAMUX1_USART3_TX
#define STM32_UART_USART6_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 5) // shared SPI5_RX,USART6_TX
...
#define HAL_I2C3_CONFIG { &I2CD3, 3, STM32_I2C_I2C3_RX_DMA_STREAM, STM32_I2C_I2C3_TX_DMA_STREAM, PAL_LINE(GPIOH,7U), PAL_LINE(GPIOH,8U) }
#else
...
#define HAL_USART1_CONFIG { (BaseSequentialStream*) &SD1, 1, false, STM32_USART1_RX_DMA_CONFIG, STM32_USART1_TX_DMA_CONFIG, PAL_LINE(GPIOB,6U), PAL_LINE(GPIOB,7U), 0, -1, 0, -1, 0}
#define HAL_HAVE_RTSCTS_SERIAL1
#define HAL_USART2_CONFIG { (BaseSequentialStream*) &SD2, 2, false, STM32_USART2_RX_DMA_CONFIG, STM32_USART2_TX_DMA_CONFIG, PAL_LINE(GPIOD,5U), PAL_LINE(GPIOD,6U), PAL_LINE(GPIOD,4U), -1, 0, -1, 0}
#define HAL_HAVE_RTSCTS_SERIAL2
#define HAL_USART3_CONFIG { (BaseSequentialStream*) &SD3, 3, false, STM32_USART3_RX_DMA_CONFIG, STM32_USART3_TX_DMA_CONFIG, PAL_LINE(GPIOD,8U), PAL_LINE(GPIOD,9U), PAL_LINE(GPIOD,12U), -1, 0, -1, 0}
#define HAL_UART4_CONFIG { (BaseSequentialStream*) &SD4, 4, false, STM32_UART4_RX_DMA_CONFIG, STM32_UART4_TX_DMA_CONFIG, PAL_LINE(GPIOD,1U), PAL_LINE(GPIOD,0U), 0, -1, 0, -1, 0}
#define HAL_HAVE_RTSCTS_SERIAL5
#define HAL_USART6_CONFIG { (BaseSequentialStream*) &SD6, 6, false, STM32_USART6_RX_DMA_CONFIG, STM32_USART6_TX_DMA_CONFIG, PAL_LINE(GPIOG,14U), PAL_LINE(GPIOG,9U), PAL_LINE(GPIOG,8U), -1, 0, -1, 0}
#define HAL_UART7_CONFIG { (BaseSequentialStream*) &SD7, 7, false, STM32_UART7_RX_DMA_CONFIG, STM32_UART7_TX_DMA_CONFIG, PAL_LINE(GPIOE,8U), PAL_LINE(GPIOF,6U), 0, -1, 0, -1, 0}
#define HAL_OTG2_CONFIG {(BaseSequentialStream*) &SDU2, 2, true, false, 0, 0, false, 0, 0}
#define HAL_UART8_CONFIG { (BaseSequentialStream*) &SD8, 8, false, STM32_UART8_RX_DMA_CONFIG, STM32_UART8_TX_DMA_CONFIG, PAL_LINE(GPIOE,1U), PAL_LINE(GPIOE,0U), 0, -1, 0, -1, 0}
...
#define HAL_USB_STRING_PRODUCT "Durandal"
